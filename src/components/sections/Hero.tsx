...
export function Hero() {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero rounded-b-[3rem] md:rounded-b-[5rem]">
      {/* Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        {/* Animated grid */}
        <div className="absolute inset-0 bg-[linear-gradient(rgba(31,107,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(31,107,255,0.03)_1px,transparent_1px)] bg-[size:60px_60px] rounded-xl" />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          delay: 0.6
            ...
            <div className="flex items-center justify-center gap-8 flex-wrap">
              {["Enterprise", "Government", "Healthcare", "Finance"].map((sector, i) => <div key={sector} className="text-primary-foreground/40 font-display font-semibold text-lg">
                  {sector}
                </div>)}
            </div>
          </motion.div>
